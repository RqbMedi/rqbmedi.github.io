...
I am an Assistant Professor in Operations and Decision Systems at Faculty of Business Administration ([FSA OSD](https://www.fsa.ulaval.ca/personnel-expert/el-mehdi-er-raqabi/)), Laval University, an Associated Member at the Groupe d'Études et de Recherche en Analyse des Décisions ([GERAD](https://www.gerad.ca/fr/people/el-mehdi-er-raqabi)), and a Member at the Centre Interuniversitaire de Recherche sur les Reseaux d'Entreprise, la Logistique et le Transport ([CIRRELT](https://www.cirrelt.ca/)). I am also a Research Affiliate at the H. Milton Stewart School of Industrial and Systems Engineering ([ISyE](https://www.isye.gatech.edu/users/el-mehdi-er-raqabi)) and the NSF AI Research Institute for Advances in Optimization ([AI4OPT](https://www.ai4opt.org/)), Georgia Institute of Technology. Prior to that, I spent one year as a Postdoctoral Researcher at ISyE & AI4OPT, working with Prof. [Pascal Van Hentenryck](https://www.isye.gatech.edu/users/pascal-van-hentenryck).
